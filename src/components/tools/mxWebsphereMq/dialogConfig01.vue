<template>
  <div style="display: contents;overflow: hidden;">
    <div class="f-full">
      ...
      <div
          style="margin-bottom:0px; display: flex;flex-direction: row;justify-content: space-around;align-items: center; ">
        <div style="display: flex;border: ridge; padding: 5px; border-radius: 10px;">
          ...
          <div
              style="display: flex;align-items: flex-start;flex-direction: column;border-left-style: dashed;padding-left: 5px;">
...
export default {
  ...
  methods: {
    configOk(evt) {
      ...
      data.config = {};
      data.config.ip = this.ip;
      data.config.port = this.port;
      data.config.qm = this.qm;
      data.config.qName = this.qName;
      data.config.user = this.user;
      data.config.pass = this.pass;
      data.config.channelName = this.channelName;
    ...
    testConnection() {
      ...
      config.qm = this.qm || config.qm;
      config.qName = this.qName || config.qName;
      config.user = this.user || config.user;
      config.pass = this.pass || config.pass;
      config.channelName = this.channelName || config.channelName;
      config.instance = this.instance || config.instance;
