<template>
  <div>
    <mx-color-picker @close="closeColorPicker" :show="showColorPicker" :cell="cell"></mx-color-picker>
    <alignment @close="closeAlignment" :show="showAlignment" :cell="cell"></alignment>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    configureStylesheet: function(graph) {
      ...
      style[ mxConstants.STYLE_LABEL_PADDING ] = '50';
  ...
  mounted() {
    ...
    graph.popupMenuHandler.factoryMethod = function(menu, cell, evt) {
      ...
      if (cell != null && cell.getType() === 'info') {
        ...
        menu.addItem('Alignment', 'editors/images/align.png', function() {
          that.cell = cell;
          that.showAlignment = true;
        });
      }
    };
